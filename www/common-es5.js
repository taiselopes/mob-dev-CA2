...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getEpisodes() {
          https: //www.breakingbadapi.com/api/characters?results=20&page=0
          return this.http.get("https://www.breakingbadapi.com/api/episodes?results=10&page=".concat(this.page));
        }
      }, {
        key: "getEpisode",
        ...
        value: function getCharacters() {
          return this.http.get("https://breakingbadapi.com/api/characters?results=10&page=".concat(this.page));
        }
      }, {
        key: "getCharacter",
  ...
  function srcAppServicesFavouritesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY_CHAR = 'favouriteCharacters';
    ...
    var FavouritesService = /*#__PURE__*/function () {
      ...
      _createClass(FavouritesService, [{
        ...
        key: "isFavouriteCharacters",
        value: function isFavouriteCharacters(charactersId) {
        ...
        value: function favouriteCharacters(charactersId) {
          var _this3 = this;

          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              result.push(charactersId);
              return _this3.storage.set(STORAGE_KEY_CHAR, result);
            } else {
              return _this3.storage.set(STORAGE_KEY_CHAR, [charactersId]);
            }
          });
        }
      }, {
        key: "unfavouriteCharacters",
        value: function unfavouriteCharacters(charactersId) {
          var _this4 = this;
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE_KEY_CHAR, result);
            }
          });
        }
      }]);
    ...
    FavouritesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], FavouritesService);
    /***/
  }
}]);
